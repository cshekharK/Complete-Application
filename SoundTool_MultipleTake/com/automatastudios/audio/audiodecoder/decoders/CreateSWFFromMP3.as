package com.automatastudios.audio.audiodecoder.decoders
{
	...
	public class CreateSWFFromMP3
	{


		public var _byteArray:ByteArray;

		public function CreateSWFFromMP3()
		{
			_byteArray = abcDataToByteArray();

		}


		public function swf(mp3:ByteArray):ByteArray
		{
			...
			swf.tags.push(TagDoABC.create(_byteArray));
		...
		private function abcDataToByteArray():ByteArray
		{
